...
const faqs = [
  ...
  {
    q: "Can I use ChatGPT Image 2.0 generated images commercially?",
    a: "Yes. Every image you generate with ChatGPT Image 2.0 is yours to use for personal and commercial projects — marketing campaigns, client deliverables, product listings, ad creatives, editorial content, and more. There are no watermarks, no attribution requirements, and no hidden licensing fees. Full commercial rights are included with every generation.",
  },
  {
    q: "Does ChatGPT Image 2.0 support image-to-image generation?",
  ...
  {
    q: "How much does it cost per image with ChatGPT Image 2.0?",
  ...
  {
    q: "What image formats, resolutions, and aspect ratios does ChatGPT Image 2.0 support?",
  ...
  {
    q: "How do I write effective prompts for ChatGPT Image 2.0?",
  ...
  {
    q: "Does ChatGPT Image 2.0 use my prompts or images for training?",
  ...
  {
    q: "Is there an API for ChatGPT Image 2.0?",
  ...
  {
    q: "What is the refund policy for ChatGPT Image 2.0 credit packs?",
    ...
    <section className="py-24 px-6" style={{ background: "var(--bg2)" }}>
      <div className="max-w-3xl mx-auto">
        ...
        <h2 className="text-3xl md:text-5xl font-extrabold tracking-tight text-center mb-4">
          Frequently Asked Questions About ChatGPT Image 2.0
        </h2>
        <p className="text-center text-lg mb-12 max-w-xl mx-auto" style={{ color: "var(--muted)" }}>
          Everything you need to know before you start using ChatGPT Image 2.0.
        </p>
