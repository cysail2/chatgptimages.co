...
import { AiImageGenerator } from "@/library/ai/registry";
  ...
  return (
    <>
      ...
      <div className="site-marketing">
        <section className="relative overflow-hidden px-6 pt-24 pb-20" style={{ background: "var(--bg2)" }}>
          <div
            className="absolute inset-0 pointer-events-none"
            style={{
              background:
                "linear-gradient(180deg, rgba(124,92,252,0.13) 0%, rgba(10,10,15,0) 34%), radial-gradient(circle at 50% 10%, rgba(56,189,248,0.14), transparent 32%)",
            }}
          />
          <div className="absolute top-1/3 left-1/2 h-[560px] w-[560px] -translate-x-1/2 -translate-y-1/2 rounded-full blur-[120px] pointer-events-none" style={{ background: "rgba(124,92,252,0.10)" }} />
          <div className="absolute bottom-0 right-0 h-[360px] w-[360px] rounded-full blur-[100px] pointer-events-none" style={{ background: "rgba(56,189,248,0.08)" }} />
          ...
          <div className="relative z-10 mx-auto max-w-7xl">
            ...
            <div id="create" className="relative z-10 mx-auto mt-10 w-full max-w-7xl">
              <AiImageGenerator defaultModel="gpt-image-2" hideModelSelector />
            </div>
          </div>
        </section>
